...
class _EditProductPageState extends State<EditProductPage> {
  ...
  void initState() {
    ...
    departmentController =
        TextEditingController(text: widget.product['department']);
  }
  ...
  Future<void> updateProduct() async {
    try {
      ...
      request.fields['email'] = priceController.text;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("แก้ไขข้อมูลนักศึกษา")),
      body: Padding(
          ...
          child: Column(
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: "ชื่อนักศึกษา"),
              ),
